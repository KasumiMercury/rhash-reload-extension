export default function LongStringDisplay({ text }: { text: string }) {
	return (
		<div className="w-full h-fit cursor-pointer relative text-left py-1 px-2 rounded-md border border-zinc-300">
			...
			<div className="hidden peer-hover:block absolute h-fit max-w-full bottom-0 left-1/2 -translate-x-1/2 translate-y-full bg-zinc-900 z-10 border-zinc-300 border text-left break-words p-2 rounded-md">
				{text}
			</div>
		</div>
	);
